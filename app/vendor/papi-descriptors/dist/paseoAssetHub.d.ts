...
export type PaseoAssetHubDispatchError = Anonymize<I72ju98lulovhp>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type PaseoAssetHubExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PaseoAssetHub = {
    ...
    asset: IAsset;
    extensions: PaseoAssetHubExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: PaseoAssetHub;
export default _allDescriptors;
export type PaseoAssetHubApis = ApisFromDef<IRuntimeCalls>;
export type PaseoAssetHubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type PaseoAssetHubCalls = TxFromPalletsDef<PalletsTypedef>;
export type PaseoAssetHubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type PaseoAssetHubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type PaseoAssetHubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type PaseoAssetHubViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type PaseoAssetHubCallData = Anonymize<I7ghpul17sf1lm> & {
    value: {
        type: string;
    };
};
